...
def build_repair_plan(registry: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    steps.append(
        _step(
            ...
            touched_paths=[
                str(LAUNCHAGENTS_DIR / "com.sereja.telegram-*.plist"),
                str(LAUNCHAGENTS_DIR / "com.sereja.telecrawl*.plist"),
                str(POLICY_DIR / "allowed-roots.json"),
            ],
            dry_run_commands=[
    ...
    steps.append(
        _step(
            ...
            touched_paths=[
                str(POLICY_DIR / "sessions.json"),
            ],
            dry_run_commands=[
                [str(CONTROL_ROOT / "bin/telegram-session-audit"), "--json"],
            ],
            apply_commands=[],
            rollback=[
    ...
    steps.append(
        _step(
            ...
            touched_paths=[
                str(POLICY_DIR / "source-routing.json"),
                str(MIRROR_ROOT),
            ],
            dry_run_commands=[
    ...
    steps.append(
        _step(
            ...
            dry_run_commands=[
                [str(CONTROL_ROOT / "bin/telegram-telecrawl-status"), "--json"],
            ],
            apply_commands=[],
            rollback=[
